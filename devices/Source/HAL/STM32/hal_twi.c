...
#endif
        hal_dio_gpio_cfg(GPIOB, (I2C_PIN_SCL | I2C_PIN_SDA), DIO_MODE_IN_FLOAT);  // Release GPIO
    }
...
#else
#error I2C Unknown microcontroller
#endif  //  (defined STM32F0XX_LD) || (defined STM32F0XX_MD)
