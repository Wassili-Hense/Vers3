...
#if (defined UART0_PORT) || (defined UART1_PORT) || (defined UART2_PORT) || (defined UART3_PORT)
...
static volatile uint8_t *hal_pUART[4] =
            {
            #ifdef UCSR0A
                &UCSR0A,
            #else
...
#endif  //  (defined UART0_PORT) || (defined UART1_PORT) || (defined UART2_PORT) || (defined UART3_PORT)
